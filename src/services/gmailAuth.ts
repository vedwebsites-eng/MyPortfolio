...
// Supported Gmail Scopes configured in OAuth setup
export const SCOPES = [
...
// Add all requested Workspace Gmail scopes
...
// In-memory cache for the access token ONLY (Never stored in localStorage per guidelines)
